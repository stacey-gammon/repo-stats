...
var get_repos_1 = require("./get_repos");
var rest_1 = require("@octokit/rest");
var client = new rest_1.Octokit();
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var stats, columns, csvText;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, get_repos_1.getRepoStats)(client, [
                ...
                case 1:
                    stats = _a.sent();
                    columns = Object.keys(Object.values(stats)[0]);
                    csvText = columns.join(',') + '\n';
                    Object.values(stats).forEach(function (row) {
